<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/PHP-apple-store-clone/client/view/controller/admin-onload2.php';
?>
...
<head>
    ...
    <link rel="stylesheet" href="/PHP-apple-store-clone/client/view/style/admin-page-2.css">
...
<body>
    ...
    <script src="/PHP-apple-store-clone/client/script/admin-page-2.js"></script>
</body>
